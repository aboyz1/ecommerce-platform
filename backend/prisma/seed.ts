...
async function main() {
  ...
  const products = [
    ...
    },
    {
      ...
      description:
        "The comprehensive reference to JavaScript. This book both serves as a comprehensive reference for experienced developers and as a learning guide for beginners.",
      categoryId: books.id,
      basePrice: 54.99,
      comparePrice: 69.99,
      sku: "BOOK-001",
